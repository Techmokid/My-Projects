...
#define testVariable1 true
#define testVariable2 true
...
void setup() {
  ...
  Serial.println(F("Initializing....(May take 8 seconds)"));
  ...
  Serial.println("Setting CFUN");
  fona.write("AT+CFUN=1\r");
  Serial.println("CFUN set");
...
void printMenu(void) {
  ...
  Serial.println(F("[/] Reset SIM7000 module"));
  Serial.println(F("-------------------------------------"));
  Serial.println(F(""));
...
void loop() {
  ...
  switch (command) {
    ...
    case 'y': {
        ...
        if (!fona.enableNTPTimeSync(true))
