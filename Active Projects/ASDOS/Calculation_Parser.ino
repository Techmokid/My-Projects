...
String detectFunctions(String in) {
  ...
  while(containsLetter(in)) {
    int positionToCheck = in.indexOf(F("sin"));
    ...
    positionToCheck = in.indexOf(F("cos"));
    if (positionToCheck != -1) {
      int endBracketIndex = endBracket(positionToCheck,in);
    ...
    positionToCheck = in.indexOf(F("tan"));
    if (positionToCheck != -1) {
      int endBracketIndex = endBracket(positionToCheck,in);
    ...
    positionToCheck = in.indexOf(F("asin"));
    if (positionToCheck != -1) {
      int endBracketIndex = endBracket(positionToCheck,in);
    ...
    positionToCheck = in.indexOf(F("acos"));
    if (positionToCheck != -1) {
      int endBracketIndex = endBracket(positionToCheck,in);
    ...
    positionToCheck = in.indexOf(F("atan"));
    if (positionToCheck != -1) {
      int endBracketIndex = endBracket(positionToCheck,in);
