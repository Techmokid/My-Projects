...
namespace WebAPIClient {
	class Program {
		static string filePath = "C:/Users/aj200/Documents/GitHub/My-Projects/Active Projects/2B. C# Crypto AI Executer";
        ...
        static void Main(string[] args) {
			...
			API.filePath = "C:/Users/aj200/Desktop/Backups/SaveData/HistoricDataCache.txt";
			...
			Genome activeAIGenome = nn.getBestGenome();
			AIStatusText2.data =   "      Running";
			AIStatusText3.data = "";
			AIStatusText4.data = "";
			DisplayManager.updateDisplays();
			
			DebugFile.Create("C:/Users/aj200/Desktop/Backups/2. C# CNN/debugging.txt");
			while (true) {
				...
				foreach(List<string> i in sellList) {
					...
					if (sellWalletValue > 20) {
						Thread.Sleep(15000 / sellList.Count);
				...
				foreach(List<string> i in buyList) {
					if (buyWalletValue > 20) {
						Thread.Sleep(15000 / buyList.Count);
