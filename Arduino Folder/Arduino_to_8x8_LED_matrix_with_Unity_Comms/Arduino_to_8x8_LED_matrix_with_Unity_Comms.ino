...
void loop () {
  /*
  maxOne(Module #, line #, data to write to line);
  ...
  */
  ...
  String extraInputs = String(analogRead(A2)) + "_" + String(analogRead(A3)) + "_" + String(analogRead(A4)) + "_" + String(analogRead(A5));
  String sentenceToSend = buttons + "_" + Joystick + "_" + extraInputs;
